...
public class RooConfig implements Serializable {
    ...
    public RooConfig() {
        this.hsvHMin = -1;
        this.hsvHmax = Integer.MAX_VALUE;
        this.hsvSMin = -1;
        this.hsvSMax = Integer.MAX_VALUE;
        this.hsvVMin = -1;
        this.hsvVmax = Integer.MAX_VALUE;
        this.hslHMin = -1;
        this.hslHmax = Integer.MAX_VALUE;
        this.hslSMin = -1;
        this.hslSMax = Integer.MAX_VALUE;
        this.hslLmin = -1;
        this.hslLmax = Integer.MAX_VALUE;
        this.rMin = -1;
        this.rMax = Integer.MAX_VALUE;
        this.gMin = -1;
        this.gMax = Integer.MAX_VALUE;
        this.bMin = -1;
